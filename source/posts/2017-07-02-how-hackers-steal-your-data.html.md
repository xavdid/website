...
So here I am, a hacker. I'm looking to make a quick buck, so I'm going to spend my afternoon breaking into your account(s) and putting them up for sale. Don't take it personally. Unless you're rich and/or famous, I'm probably not targeting you. In fact, I hardly know you exist; you're a line in a file. Rather than focus on specific people, I'm going to target accounts in bulk. I just [bought](https://www.theatlantic.com/technology/archive/2016/02/the-black-market-for-netflix-accounts/462321/) a dump of 400,000 hashes leaked from a forum hack a few years ago.[^1] I'm going to use a program that cracks each password and tests those credentials with other services. If your Yahoo password is used for your Twitter account, I now own both of them. I can do this process quickly, testing hundreds of accounts per second. So here's your first tip:

### 1. Don't reuse passwords

Password re-use is only an issue if companies are breached. Well, large-scale password breaches happen with startling frequency. There's a great site called [HaveIBeenPwned](https://haveibeenpwned.com/) that maintains a list of all the services that have announced that they've been hacked. You can check whether or not your data has ever known to have been compromised by inputting your email.[^2] Scary, huh? Even if you've gotten lucky and you've never been pwned, their [list of sites](https://haveibeenpwned.com/PwnedWebsites) is concerning. Your passwords are only as strong as the weakest site you use them on. It doesn't matter how good the security at Instagram is if you use the same password for say, your [Adobe](https://www.theguardian.com/technology/2013/nov/07/adobe-password-leak-can-check) account as well.
...
As I'm going through the passwords in this hypothetical hack scenario, I'm going to try each of the 1 million items in my starting list. More than likely, that approach will crack half of the passwords without any effort and I won't bother moving onto the hard ones. As a responsible internet user, it's in your best interest to take all actions possible to plant yourself firmly in that second camp. Using a password manager correctly is the easiest way to do this.

So now you're using a password manager (correctly). Good for you! Much like a zombie attack, you don't need to be the fastest person, you just want to avoid being the slowest. By taking 30 minutes to start using complex passwords, you've put yourself head and shoulders above other internet users. If you want to double down for you most sensitive accounts (like your main email), there's one more trick up our sleeves.
...
>
> 1. Your phone number can be easily hijacked by someone who calls the phone company and pretends to be you. [^6]
...
While nothing is 100% in internet security, you owe it to yourself to become as aggravating a target as possible. If you're interested in reading more, I recommend [decentsecurity.com](https://decentsecurity.com/#/introduction/), this great [security muiltireddit](https://www.reddit.com/user/Kalabaster/m/supasec/), and generally lurking on [Hacker News](https://news.ycombinator.com/).
...
[^6]: While a targeted vector like [sim hijacking](https://motherboard.vice.com/en_us/article/mg7bd4/how-a-hacker-can-take-over-your-life-by-hijacking-your-phone-number) is separate from the bulk-based attack we've been stepping through, it's definitely something to be aware of.
