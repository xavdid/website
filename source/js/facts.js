...
var facts = [
    ...
    'I really like design, but I\'m terrible at starting from scratch.',
    'If you reload this site enough, you\'ll eventually see all the facts.',
    'I was born in Houston, TX, lived in Boulder, CO from 4th to 10th grade, then moved back to Houston for the last two years of high school. I never really know what to say when people ask where I\'m from.',
    'I really like teaching. If software dev doesn\'t work out for whatever reason, I\'ll probably be a computer science professor.',
    ...
    'This site is written in <a href="http://haml.info">haml</a>, meaning I can\'t end a sentence in a link or it looks like <a href="#">this</a> . This lead to a lot of non-concise language to re-order word choice.',
    ...
    'I run a <a href="http://www.twitter.com/not_andrew_ax">parody twitter account</a> about one of my housemates. It\'s actually pretty funny if you know him at all. Imagine a lax bro who picked up a CS degree. It mainly fun because I really get into his head when I tweet.',
