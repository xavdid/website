...
ogDesc: "david.reviews: Rust! It's neat, but not without its warts."
---
...
- [backdating my Exercism repo](https://github.com/xavdid/exercism/tree/main/_meta/repo-builder) ([blog post](/blog/post/backdating-my-exercism-repo/))
