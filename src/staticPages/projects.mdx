...
I've spent a lot of time over the years writing code. Sometimes for money, other times for fun. Some projects get formal releases and versions, many more don't.
...
- [Potent](https://github.com/xavdid/potent), a tool for running commands idem**potent**ly across directories.
...
- [This Website](https://github.com/xavdid/website)! It's the fourth major version of my personal site, currently built using Astro. Read more [on the blog](/blog/post/another-site-rewrite/).

### Through work

- While at [Stripe](https://stripe.com), I maintained all 7 of the SDKs (Java, Python, Ruby, PHP, Go, Node, and .NET) and the [code generation pipeline](https://brandur.org/fragments/stripe-codegen) that produces them.
...
- I wrote about [handling events](https://stripe.dev/blog/event-notification-handlers-thin-events) on Stripe's dev blog.
