...
var facts = [
  ...
  'I attended (and then worked at) <a href="http://www.campstewart.com" target="_blank" rel="noopener">Camp Stewart</a> for 7 different summers. More than anything else, I believe that affected the person I became today. Everyone should go to camp.',
  ...
  'XKCD is brilliant, especially <a href="https://xkcd.com/1037/" target="_blank" rel="noopener">this</a> one.',
...
var i = getRandomIndex(facts.length - 1)
$('.fact').html(facts[i])
